            ...
            <div class="p-3">
                <form action="{{route('admin.console.store')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="console_name" value="{{old('console_name')}}" placeholder="Enter Console's Name" name="console_name">
                        <span style="color:red"> @error ('console_name'){{$message}}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="name">Console Description:</label>
                        <textarea class="form-control" id="console_description" name="console_description" placeholder="Enter Console's Description" rows="4">{{old('console_description')}}</textarea>
