            ...
            <table class="table table-bordered" id="items">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a type="button" class="btn btn-danger" href="{{route('offer.reject',$offer->id)}}">Reject <i class="fas fa-times"></i></a>
                            <a type="button" class="btn btn-success" href="{{route('offer.accept',$offer->id)}}">Accept <i class="fas fa-check"></i></a>
                        </td>
                    </tr>
                    @endforeach
